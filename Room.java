...
public class Room {
	 ...
	 * */
	public Room(boolean north, boolean south, boolean east, boolean west, String n, String d) {
		description = d;
		name = n; 
		canGoNorth = north;
		canGoSouth = south;
	...
	public Room(boolean north, boolean south, boolean east, boolean west, String n, String d, Item i) {
		description = d;
		name = n; 
		canGoNorth = north;
		canGoSouth = south;
	...
	public Room(boolean north, boolean south, boolean east, boolean west, String n, String d, Item i, boolean northL, boolean southL, boolean eastL, boolean westL) {
		description = d;
		name = n; 
		canGoNorth = north;
		canGoSouth = south;
